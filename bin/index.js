...
var createColor = (0, _utils.compose)(_utils.getMiddleColor, _utils.getTwoMaxColors, _utils.sortByPercent, _utils.checkOfPercent, _utils.sortByPercent, _utils.checkOfTransparent, _utils.createColorModel);
        ...
        css.walkRules(function (rule) {
            ...
            rule.walkDecls('background', function (decl) {
                ...
                if (decl.value.indexOf('gradient') !== -1) {
                    if (firstRull) {
                        var middleColor = createColor(decl, firstRull);
